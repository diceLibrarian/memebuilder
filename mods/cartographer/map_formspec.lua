...
local TILE_OFFSET = 0.23; -- Slightly smaller than TILE_SIZE. We overlap tiles slightly to minimize seams
    ...
    for i = 0,w,1 do
        ...
        for j = h,0,-1 do
            ...
            if column == nil or column[world_j] == nil or (is_visible and not is_visible(..., x + i, y + j)) then
                ...
                local biome = biomes.get_texture(name, math.floor(height + 0.5), heat, humidity, detail)
